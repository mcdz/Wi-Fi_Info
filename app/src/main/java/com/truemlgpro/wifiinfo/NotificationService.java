...
public class NotificationService extends Service {
    ...
    public void showNotificationAPI29() {
        ...
        builder.setContentTitle("Local IP: " + ip);
        builder.setContentText(info);
        builder.setWhen(System.currentTimeMillis());
        builder.addAction(R.drawable.ic_stop, "Stop Services", pIntentActionStop);
        builder.addAction(R.drawable.ic_settings, "Notification Settings", pIntentActionSettings);
        builder.setChannelId(channelID);
        builder.setColorized(true);
        builder.setColor(getResources().getColor(R.color.ntfcColor));
        builder.setCategory(Notification.CATEGORY_SERVICE);
        builder.setOngoing(true);
        builder.setOnlyAlertOnce(true);
        builder.setAutoCancel(false);
        notification29 = builder
                .build();
